...
public class APIGenerator {
    ...
    private static final String DATA_MODEL_PACKAGE = "hollow.producer.datamodel";
    private static final String GENERATED_API_PACKAGE = "hollow.consumer.api.generated";
